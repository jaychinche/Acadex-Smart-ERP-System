...
export default function AppAppBarTeacher() {
      ...
      <Container maxWidth="lg">
        ...
        <StyledToolbar variant="dense" disableGutters>
          <Box sx={{ flexGrow: 1, display: "flex", alignItems: "center", px: 0 }}>
            <Link to="/dashboard-teacher" style={{ textDecoration: "none", display: "flex", alignItems: "center" }}>
              <Sitemark />
            </Link>
            <Box sx={{ display: { xs: "none", md: "flex" } }}>
            <Button component={Link} to="/courses-list-teacher" variant="text" color="info" size="small">
              Courses
              </Button>
            <Button component={Link} to="/notification-teacher-receview" variant="text" color="info" size="small">
               Notification
              </Button>

              <Button component={Link} to="/dashboard-teacher" variant="text" color="info" size="small">
                About Us
              </Button>
              <Button component={Link} to="/dashboard-teacher" variant="text" color="info" size="small">
                Contact Us
