...
export default function AppAppBarAdmin() {
      ...
      <Container maxWidth="lg">
        ...
        <StyledToolbar variant="dense" disableGutters>
          <Box sx={{ flexGrow: 1, display: "flex", alignItems: "center", px: 0 }}>
            <Link to="/dashboard-admin" style={{ textDecoration: "none", display: "flex", alignItems: "center" }}>
              <Sitemark />
            </Link>
            <Box sx={{ display: { xs: "none", md: "flex" } }}>
            <Button component={Link} to="/view-and-manage-student" variant="text" color="info" size="small">
                Student
              </Button>
              <Button component={Link} to="/view-and-manage-teacher" variant="text" color="info" size="small">
                Teacher
              </Button>
              <Button component={Link} to="/notification-send" variant="text" color="info" size="small">
               Notification
              </Button>
            </Box>
          </Box>
